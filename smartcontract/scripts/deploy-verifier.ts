...
async function deployVerifier() {
  ...
  const ofacEnabled = process.env.SELF_OFAC_ENABLED !== "false"; // Default true

  // Parse forbidden countries from env (comma-separated) or use defaults
  const forbiddenCountriesStr = process.env.SELF_FORBIDDEN_COUNTRIES || "CUB,IRN,PRK,RUS";
