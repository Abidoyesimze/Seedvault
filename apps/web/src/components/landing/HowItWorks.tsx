    ...
    <section ref={ref} className="py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {steps.map((s, i) => (
            <div key={s.title} className={`p-6 rounded-lg border border-input bg-card/50 backdrop-blur-sm transform transition-all ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`} style={{ transitionDelay: `${i * 120}ms` }}>
